...
## Contexto
A ADR-0006 definiu um mecanismo próprio de sincronização entre o SQLite local e o PostgreSQL remoto, usando o algoritmo "Último Timestamp Vence" (Last Write Wins) implementado manualmente pela equipe. Esse componente foi identificado no RVS (seção 4) como o **risco técnico de maior criticidade** do projeto, exigindo um spike técnico e POC dedicados nas Semanas 1–2 do cronograma.
